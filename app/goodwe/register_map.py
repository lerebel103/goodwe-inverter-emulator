...
def _runtime_data(regs: dict[int, int], snapshot: Snapshot) -> None:
    ...
    put_u16(regs, 35122, 100)
    put_u16(regs, 35123, 5000)
    put_i32(regs, 35124, int(snapshot.meter_power_w / 3))
    put_u16(regs, 35126, int(snapshot.meter_voltage_l2_v * 10))
    put_u16(regs, 35127, 100)
    put_u16(regs, 35128, 5000)
    put_i32(regs, 35129, int(snapshot.meter_power_w / 3))
    put_u16(regs, 35131, int(snapshot.meter_voltage_l3_v * 10))
    put_u16(regs, 35132, 100)
    put_u16(regs, 35133, 5000)
    put_i32(regs, 35134, int(snapshot.meter_power_w / 3))
