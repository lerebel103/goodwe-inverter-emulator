...
def _runtime_data(regs: dict[int, int], snapshot: Snapshot) -> None:
    ...
    put_u16(regs, 35121, int(snapshot.meter_voltage_l1_v * 10))
    put_u16(regs, 35122, int(snapshot.meter_current_l1_a * 10.0))
    put_u16(regs, 35123, int(snapshot.meter_frequency_hz * 100.0))
    put_i32(regs, 35124, int(snapshot.meter_power_l1_w))
    put_u16(regs, 35126, int(snapshot.meter_voltage_l2_v * 10))
    put_u16(regs, 35127, int(snapshot.meter_current_l2_a * 10.0))
    put_u16(regs, 35128, int(snapshot.meter_frequency_hz * 100.0))
    put_i32(regs, 35129, int(snapshot.meter_power_l2_w))
    put_u16(regs, 35131, int(snapshot.meter_voltage_l3_v * 10))
    put_u16(regs, 35132, int(snapshot.meter_current_l3_a * 10.0))
    put_u16(regs, 35133, int(snapshot.meter_frequency_hz * 100.0))
    put_i32(regs, 35134, int(snapshot.meter_power_l3_w))
    ...
    put_i16(regs, 35140, int(snapshot.meter_power_w))
